...
function Model(props) {
	...
	//Rightnow Colors are not changing so to change color we will use useTexture
	const texture = useTexture(props.item.img); //this contain mesh we wanna cover our phone with.
	...
	return (
		<group {...props} dispose={null}>
			...
			<mesh
				...
				scale={0.01}
			>
				//To more texture and color to main IPHone model
